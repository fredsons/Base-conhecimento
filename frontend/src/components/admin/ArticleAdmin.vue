<template>
    <div class="article-admin">
        <b-form>
            ...
            <b-button class="danger"  v-if="mode === 'remove'" @click="remove">Excluir</b-button>
            <b-button  class="ml-2 danger" @click="reset">Cancelar</b-button>
        </b-form>
        <hr />
        <b-table hover striped :items="articles" :fields="fields">
            <template slot="actions" slot-scope="data">
                <b-button title="Editar artigo" variant="warning" @click="loadArticle(data.item)" class="mr-2">
                    <i class="fa fa-pencil" title="Editar artigo" ></i>
                </b-button>

                <b-button class="danger" title="Excluir artigo"   @click="loadArticle(data.item, 'remove')">
                    <i class="fa fa-trash" title="Excluir artigo"></i>
                </b-button>
            </template>
        </b-table>
